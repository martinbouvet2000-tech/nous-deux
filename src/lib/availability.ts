...
export const STATUSES: StatusDef[] = [
  { key: 'free',          label: 'Dispo',                    hint: 'Appelle quand tu veux',              color: '#7FCB9A', shade: '#4F9A6B' },
  ...
  { key: 'unavailable',   label: 'Pas dispo',                hint: 'Je te rappelle plus tard',            color: '#9B9287', shade: '#6E675E' },
]
